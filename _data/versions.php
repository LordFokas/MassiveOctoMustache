<?php
	...
	class VersionList{
		...
		public static function init(){
			...
			"http://minecraft.curseforge.com/mc-mods/226769-stargatetech-2/files/2223786"))->setChangelog((new Changelog())
			...
			"http://minecraft.curseforge.com/mc-mods/226769-stargatetech-2/files/2223785"))->setChangelog((new Changelog())
				-> alt("Ported to Minecraft 1.7.10")
				-> fix("Minor fixes.")
			);
			
			self::$bcVersions[] = (new DependentVersion("0.7.4 Alpha", "29-Jul-14", "1.6.4", "TE 3.0.0.2", "965",
			"http://minecraft.curseforge.com/mc-mods/226769-stargatetech-2/files/2223784"))->setChangelog((new Changelog())
			...
			"http://minecraft.curseforge.com/mc-mods/226769-stargatetech-2/files/2223783"))->setChangelog((new Changelog())
			...
			"http://minecraft.curseforge.com/mc-mods/226769-stargatetech-2/files/2223782"))->setChangelog((new Changelog())
			...
			"http://minecraft.curseforge.com/mc-mods/226769-stargatetech-2/files/2223781"))->setChangelog((new Changelog())
			...
			"http://minecraft.curseforge.com/mc-mods/226769-stargatetech-2/files/2223780"))->setChangelog((new Changelog())
			...
			"http://minecraft.curseforge.com/mc-mods/226769-stargatetech-2/files/2223779"))->setChangelog((new Changelog())
			...
			"http://minecraft.curseforge.com/mc-mods/226769-stargatetech-2/files/2223778"))->setChangelog((new Changelog())
			...
			"http://minecraft.curseforge.com/mc-mods/226769-stargatetech-2/files/2223777"))->setChangelog((new Changelog())
			...
			"http://minecraft.curseforge.com/mc-mods/226769-stargatetech-2/files/2223776"))->setChangelog((new Changelog())
			...
			"http://minecraft.curseforge.com/mc-mods/226769-stargatetech-2/files/2223775"))->setChangelog((new Changelog())
			...
			"http://minecraft.curseforge.com/mc-mods/226769-stargatetech-2/files/2223774"))->setChangelog((new Changelog())
				-> add("Abstract Bus")
			...
			"http://minecraft.curseforge.com/mc-mods/226769-stargatetech-2/files/2223773"))->setChangelog((new Changelog())
			...
			"http://minecraft.curseforge.com/mc-mods/226769-stargatetech-2/files/2223772"))->setChangelog((new Changelog())
				-> add("Stargates")
			);
			
			self::$bcVersions[] = (new DependentVersion("0.4.2 Alpha", "06-Nov-13", "1.6.4", "BC 4.1.0", "942",
			"http://minecraft.curseforge.com/mc-mods/226769-stargatetech-2/files/2223771"))->setChangelog((new Changelog())
			...
			"http://minecraft.curseforge.com/mc-mods/226769-stargatetech-2/files/2223770"))->setChangelog((new Changelog())
			...
			"http://minecraft.curseforge.com/mc-mods/226769-stargatetech-2/files/2223769"))->setChangelog((new Changelog())
			...
			"http://minecraft.curseforge.com/mc-mods/226769-stargatetech-2/files/2223768"))->setChangelog((new Changelog())
			...
			"http://minecraft.curseforge.com/mc-mods/226769-stargatetech-2/files/2223767"))->setChangelog((new Changelog())
			...
			"http://minecraft.curseforge.com/mc-mods/226769-stargatetech-2/files/2223766"))->setChangelog((new Changelog())
			...
			"http://minecraft.curseforge.com/mc-mods/226769-stargatetech-2/files/2223765"))->setChangelog((new Changelog())
				-> add("Transport Ring Platform")
			);
			
			self::$bcVersions[] = (new DependentVersion("0.1.2 Alpha", "28-Aug-13", "1.6.2", "BC 4.0.0", "842",
			"http://minecraft.curseforge.com/mc-mods/226769-stargatetech-2/files/2223764"))->setChangelog((new Changelog())
			...
			"http://minecraft.curseforge.com/mc-mods/226769-stargatetech-2/files/2223763"))->setChangeLog((new Changelog())
			...
			"http://minecraft.curseforge.com/mc-mods/226769-stargatetech-2/files/2223762"))->setChangelog((new Changelog())
				-> add("Shield Emitters")
